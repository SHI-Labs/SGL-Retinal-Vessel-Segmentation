...
class GridNet(nn.Module):
    def __init__(self, inc=3):
        ...
        self.sample = self.conv_block(64, 6)  #128 * 128 * 8 * 1
    ...
    def forward(self, x):
        ...
        u2 = self.conv8(u2)
        out_grid = self.act(self.sample(u2)).view(-1, 3, 2, 128, 128)
        return out_grid
...
class EnhanceNet(nn.Module):
    ...
    def forward(self, x):
        ...
        colored = self.slice_layer(bgrid, guide) #predication 1 and the guidance map
