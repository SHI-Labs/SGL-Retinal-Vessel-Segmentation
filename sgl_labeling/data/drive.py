...
class DRIVE(dbdata.DBData):
    def __init__(self, args, name='DRIVE', train=True, benchmark=False):
    ...
    def _scan(self):
        super_names_hr  = super(DRIVE, self)._scan()
        names_hr = []
    ...
    def _set_filesystem(self, dir_data):
        super(DRIVE, self)._set_filesystem(dir_data)
